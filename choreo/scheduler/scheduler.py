...
from choreo.multirq.exceptions import NoSuchJobError
from choreo.multirq.job import Job
from choreo.multirq.queue import Queue
from choreo.multirq.utils import backend_class
...
class Scheduler(object):
    ...
    def __init__(self, queue_name='default', queue=None, interval=60, connection=None,
        ...
        from choreo.multirq.connections import resolve_connection
    ...
    def enqueue_at(self, scheduled_time, func, *args, **kwargs):
        ...
        from choreo.multirq.scheduler import Scheduler
